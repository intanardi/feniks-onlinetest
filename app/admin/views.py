...
def open_pdf(filename):
    ...
    print(directory)
    return render_template('admin/examination_pdf/preview.html', directory=directory)
...
def examination_edit(id):
    ...
    if request.method == 'POST':
        ...
        db.session.commit()
        return redirect(url_for('admin.examination_data'))
    return render_template('admin/examination/edit.html', examination=examination, minutes=int(minutes))
...
def question_edit(id):
    ...
    if request.method == 'POST':
        ...
        db.session.commit()
        return redirect(url_for('admin.question_data'))
    return render_template('admin/examination_pdf/edit.html', level=level, division=division, question=question)
...
@admin.route('/question/fuck/<id>', methods=['GET', 'POST'])
@login_required
def fuck(id):
    print(232132312)
